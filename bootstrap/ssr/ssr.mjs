...
function hr({ props: e, attrs: t, slots: r, slot: n, name: i }) {
  ...
  if (n) {
    ...
    for (let [d, m] of Object.entries(n))
      typeof m == "boolean" && (p = true), m === true && v.push(d);
...
`)].join(`
`));
      let d = Mi((a = p.props) != null ? a : {}, l), m = cloneVNode(p, d);
      for (let f in d)
...
let ht = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
  ...
  return () => {
    ...
    return h$1(Fragment, [Boolean(f & 4) && h$1($r, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: u, features: Ht.Focusable }), J({ ourProps: m, theirProps: { ...t, ...$ }, slot: d, attrs: t, slots: r, name: "FocusTrap" }), Boolean(f & 4) && h$1($r, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: u, features: Ht.Focusable })]);
  };
} }), { features: Ki }), Ue = [];
...
let Ft = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", rn = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: Ft }, initialFocus: { type: Object, default: null }, id: { type: String, default: () => `headlessui-dialog-${Ze()}` } }, emits: { close: (e) => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
  ...
  let d = computed(() => a.value && u.value ? 0 : 1), m = computed(() => d.value === 0), f = computed(() => o.value > 1), g = inject(xr, null) !== null, w = computed(() => f.value ? "parent" : "leaf"), $ = computed(() => l !== null ? (l.value & G.Closing) === G.Closing : false), A = computed(() => g || $.value ? false : m.value), S = computed(() => {
    var E, T, q;
  ...
  Ln(S, A);
  let O = computed(() => f.value ? true : m.value), b = computed(() => {
    var E, T, q;
  ...
  let C = computed(() => !(!m.value || f.value));
  ou(() => L(), (E, T) => {
    _.close(), nextTick(() => T == null ? void 0 : T.focus());
  }, C);
  let M = computed(() => !(f.value || d.value !== 0));
...
let ns = Vt.RenderStrategy, ut = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
  ...
  i({ el: c, $el: c });
  let { show: d, appear: m } = Lu(), { register: f, unregister: g } = ku(), w = { value: true }, $ = Ze(), A = { value: false }, S = rs(() => {
  ...
  return onMounted(() => {
    ...
    return J({ ourProps: { ...p, as: "template" }, theirProps: {}, slot: {}, slots: { ...n, default: () => [h$1(Ru, { onBeforeEnter: () => t("beforeEnter"), onAfterEnter: () => t("afterEnter"), onBeforeLeave: () => t("beforeLeave"), onAfterLeave: () => t("afterLeave"), ...r, ...p, ...c }, n.default)] }, attrs: {}, features: ns, visible: a.value === "visible", name: "Transition" });
  };
} });
const Du = {
  props: {
...
function dn(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, i = n === void 0 ? e.placement : n, s = r.strategy, a = s === void 0 ? e.strategy : s, o = r.boundary, l = o === void 0 ? dc : o, u = r.rootBoundary, c = u === void 0 ? cs : u, p = r.elementContext, v = p === void 0 ? vt : p, d = r.altBoundary, m = d === void 0 ? false : d, f = r.padding, g = f === void 0 ? 0 : f, w = Rc(typeof g != "number" ? g : Dc(g, ar)), $ = v === vt ? fc : vt, A = e.rects.popper, S = e.elements[m ? $ : v], O = kc(Ke(S) ? S : S.contextElement || De(e.elements.popper), l, c, a), b = st(e.elements.reference), x = fs({
    reference: b,
    element: A,
    strategy: "absolute",
    placement: i
...
function td(e) {
  var t = e.state, r = e.options, n = e.name, i = r.mainAxis, s = i === void 0 ? true : i, a = r.altAxis, o = a === void 0 ? false : a, l = r.boundary, u = r.rootBoundary, c = r.altBoundary, p = r.padding, v = r.tether, d = v === void 0 ? true : v, m = r.tetherOffset, f = m === void 0 ? 0 : m, g = dn(t, {
    boundary: l,
    rootBoundary: u,
    padding: p,
    altBoundary: c
...
function od(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var i = r.mainAxis, s = i === void 0 ? true : i, a = r.altAxis, o = a === void 0 ? true : a, l = r.fallbackPlacements, u = r.padding, c = r.boundary, p = r.rootBoundary, v = r.altBoundary, d = r.flipVariations, m = d === void 0 ? true : d, f = r.allowedAutoPlacements, g = t.options.placement, w = we(g), $ = w === g, A = l || ($ || !m ? [jt(g)] : ad(g)), S = [g].concat(A).reduce(function(_e, Ie) {
...
const hd = {
  ...
  methods: {
    ...
    handlePendingRefresh() {
      !this.pendingRefresh || h.currentStack.value === this.stack && (h.refresh(), this.pendingRefresh = false);
    },
    bindListeners() {
      this.subscription.on("pusher:subscription_succeeded", () => {
        ...
        const t = this.subscription.listen(e, (r) => {
          ...
          }), a ? this.pendingVisit = a : o ? this.pendingRefresh = true : this.events.push({ name: e, data: r }), l.length > 0 && l.forEach((u) => {
            h.pushToast(u);
